...
public class Cosmetics extends Goods {
	...
	public void addToStock() {
		...
		System.out.println("Cosmetics added to stock : " + this.getDescription());
	}
	public void applyBarcode() {
		//logic to print and apply the barcode to book.
		System.out.println("Bar code applied to cosmetics : " + this.getDescription());
	}
	public void markRetailPrice() {
		//logic to read retail price from the book table and apply the retail price.
		System.out.println("Mark retail price for the cosmetics : " + this.getDescription());
	}
